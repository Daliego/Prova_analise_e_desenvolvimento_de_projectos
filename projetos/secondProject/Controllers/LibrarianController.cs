...
namespace secondProject.Controllers
{
    public class LibrarianController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,MobileNumber")] Librarian librarian)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,MobileNumber")] Librarian librarian)
        {
            if (id != librarian.Id)
            {
                return NotFound();
