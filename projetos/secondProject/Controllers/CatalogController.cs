...
namespace secondProject.Controllers
{
    public class CatalogController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AuthorName")] Catalog catalog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AuthorName")] Catalog catalog)
        {
            if (id != catalog.Id)
            {
                return NotFound();
