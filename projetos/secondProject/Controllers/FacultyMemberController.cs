...
namespace secondProject.Controllers
{
    public class FacultyMemberController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Fname,FacultyColl,Id,Name,Address,MobileNumber")] FacultyMember facultyMember)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Fname,FacultyColl,Id,Name,Address,MobileNumber")] FacultyMember facultyMember)
        {
