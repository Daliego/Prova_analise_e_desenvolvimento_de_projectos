...
namespace secondProject.Controllers
{
    public class AlertController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IssueDate,BookName")] Alert alert)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IssueDate,BookName")] Alert alert)
        {
            if (id != alert.Id)
            {
                return NotFound();
